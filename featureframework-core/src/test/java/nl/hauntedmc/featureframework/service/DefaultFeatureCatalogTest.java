...
class DefaultFeatureCatalogTest {
    ...
    void catalogProjectsSortedPointInTimeLifecycleSnapshots() {
        ...
        FeatureMetadata vanish = descriptor("vanish");
        FeatureMetadata queue = descriptor("queue");
        ...
        assertEquals(FeatureId.of("queue"), snapshots.get(0).metadata().id());
    ...
    private static FeatureMetadata descriptor(String id) {
