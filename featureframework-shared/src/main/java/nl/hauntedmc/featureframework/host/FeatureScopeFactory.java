...
public final class FeatureScopeFactory<
    ...
    public interface ContextAssembler<F extends Feature, C, CFG, LOC, LOG, R> {
        C assemble(
                FeatureDescriptor<F, C> descriptor,
                CFG config,
                LOC localization,
                LOG logger,
                R resources
    ...
    private final Function<String, ? extends R> resourcesFactory;
    ...
    public C createContext(FeatureDescriptor<F, C> descriptor) {
        ...
        return contextAssembler.assemble(
                ...
                scope.localization(),
                scope.logger(),
                resourcesFactory.apply(descriptor.registryName())
        );
    }
