...
public class FeatureDataManager {
    public static final String PLAYER_DATA_RW_CONNECTION = "player_data_rw";
    public static final String SYSTEM_DATA_RW_CONNECTION = "system_data_rw";
    public static final String DEFAULT_REDIS_MESSAGING_CONNECTION = "hauntedmc";
    ...
    public Optional<MessagingDatabaseProvider> registerRedisMessagingProvider(String identifier) {
        return registerRedisMessagingProvider(identifier, DEFAULT_REDIS_MESSAGING_CONNECTION);
    }
    ...
    public <T extends DataAccess> Optional<T> registerRedisMessagingDataAccess(
        ...
        return registerRedisMessagingDataAccess(identifier, DEFAULT_REDIS_MESSAGING_CONNECTION, expectedType);
    }
    ...
    public Optional<ORMContext> createPlayerOrmContext(String identifier, Class<?>... entityClasses) {
        return createMySqlOrmContext(identifier, PLAYER_DATA_RW_CONNECTION, entityClasses);
    }
    ...
    public Optional<ORMContext> createSystemOrmContext(String identifier, Class<?>... entityClasses) {
        return createMySqlOrmContext(identifier, SYSTEM_DATA_RW_CONNECTION, entityClasses);
    }
