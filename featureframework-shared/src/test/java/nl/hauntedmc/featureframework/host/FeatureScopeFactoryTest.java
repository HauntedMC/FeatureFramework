...
class FeatureScopeFactoryTest {
    ...
    private static FeatureDescriptor<Feature, FeatureHostContext> descriptor(String featureName) {
        FeatureDescriptor<Feature, FeatureHostContext> descriptor = mock(FeatureDescriptor.class);
