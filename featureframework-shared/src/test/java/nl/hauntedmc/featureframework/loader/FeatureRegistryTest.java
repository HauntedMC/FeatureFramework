...
class FeatureRegistryTest {
    ...
    void returnsDefensiveSnapshotsAndRejectsNullEntries() {
        ...
        FeatureDescriptor<Feature, String> descriptor = descriptor("demo", feature);
    ...
    private static FeatureDescriptor<Feature, String> descriptor(String name, Feature feature) {
