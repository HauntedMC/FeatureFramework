...
class FeatureLoaderAlgorithmsTest {
    ...
    void resolvesKeysUsingRegistryDisplayImplementationAndLoadedNames() {
        Map<String, FeatureDescriptor<TestFeature, Object>> available = new LinkedHashMap<>();
    ...
    void ordersRequiredOptionalDiamondAndIndependentFeatures() {
        Map<String, FeatureDescriptor<TestFeature, Object>> descriptors = new LinkedHashMap<>();
    ...
    void traversalLoadsTransitiveDependenciesAndReportsFailures() {
        Map<String, FeatureDescriptor<TestFeature, Object>> descriptors = Map.of(
    ...
    void diagnosesTransitiveFeatureAndPluginGaps() {
        Map<String, FeatureDescriptor<TestFeature, Object>> descriptors = Map.of(
                ...
                "B", new FeatureDescriptor<>("B", "B", "1", TestFeature.class,
    ...
    private static FeatureLoadOrderResolver.Result resolve(
            Map<String, FeatureDescriptor<TestFeature, Object>> descriptors,
    ...
    private static FeatureDescriptor<TestFeature, Object> descriptor(String name) {
        return descriptor(name, Set.of(), Set.of());
    }

    private static FeatureDescriptor<TestFeature, Object> descriptor(String name, String displayName) {
        return new FeatureDescriptor<>(name, displayName, "1", TestFeature.class, ignored -> new TestFeature(),
                Set.of(), Set.of(), Set.of());
    }

    private static FeatureDescriptor<TestFeature, Object> descriptor(
            String name,
            Set<String> required,
            Set<String> optional
    ) {
        return new FeatureDescriptor<>(name, name, "1", TestFeature.class, ignored -> new TestFeature(),
    ...
    private static final class TestFeature implements Feature {
        @Override public String getFeatureName() { return "test"; }
        @Override public String getFeatureVersion() { return "1"; }
        @Override public List<String> getDependencies() { return List.of(); }
        @Override public List<String> getPluginDependencies() { return List.of(); }
