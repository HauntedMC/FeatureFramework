...
public final class PaperDataProviderContributor {
    private PaperDataProviderContributor() { }

    public static FeatureResourceContributor<PaperFeatureResources> create(
            Plugin plugin,
