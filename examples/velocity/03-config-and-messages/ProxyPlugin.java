...
import com.example.proxy.status.catalog.BuiltInFeatures;
...
@GenerateFeatureCatalog(
        generatedClassName = "com.example.proxy.status.catalog.BuiltInFeatures",
        featurePackage = "com.example.proxy.status",
