...
`getDefaultConfig()` and `getDefaultMessages()` describe the defaults owned by this feature. At runtime, read effective values through `getConfigHandler()` rather than opening YAML yourself.
